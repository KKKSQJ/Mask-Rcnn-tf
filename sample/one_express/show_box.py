...
label_path = '/home/kingqi/proj/data/mask-rcnn/train_data/20190325_express/labels'   #'/home/kingqi/proj/data/mask-rcnn/labels'
...
for label in os.listdir(label_path):
    ...
    # cv2.waitKey()
    # f = open('/home/kingqi/proj/data/mask-rcnn/train_data/20190325_express/labels/1553066274T3_2_.txt','r')
    # img = cv2.imread()
